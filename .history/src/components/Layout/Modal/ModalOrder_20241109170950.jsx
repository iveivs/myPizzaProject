...
import { increaceProductAmount, decreaceProductAmount } from "../../../utils/utils";
                    ...
                    <div className={styles.item}>
                        ...
                        <div className={styles.info}>
                            ...
                            <div className={styles.amount}>
                                <p className={styles.decreace} onClick={() => decreaceProductAmount(setAmount)}>–</p>
                                <p>{amount}</p>
                                <p className={styles.increace} onClick={() => increaceProductAmount(setAmount)}>+</p>
                            </div>
                            < AmountCounter decreaceProductAmount={decreaceProductAmount} increaceProductAmount={increaceProductAmount} setAmount={setAmount} />

                    ...
                    <div className={`${styles.header_options} col-3`}>
                        <div className={`${styles.cart}`}>
                            <i
                                ...
                                aria-hidden="true"
                            ></i>
                            {orderAmount.length ? (<div className={styles.cart_banner}>{orderAmount.length}</div>) : (null)}
                        </div>
                        ...
                        <div className={`${styles.account}`}  >{currentUser.login ? (<i className="fa fa-sign-out" aria-hidden="true"></i>) : null }</div>

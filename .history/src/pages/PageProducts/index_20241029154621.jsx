    ...
    return (
        <div className="indent container">
            ...
            <div class="products_filter">
                        <div class="products_filter_block products_filter_size">
                            <div class="products_filter_heading">
                                <span>Size</span>
                                <i class="ti ti-chevron-down"></i>
                            </div>
                            <ul class="products_filter_menu">
                                <li class="products_filter_menu_item active">All</li>
                                <li class="products_filter_menu_item">Small</li>
                                <li class="products_filter_menu_item">Middle</li>
                                <li class="products_filter_menu_item">Big</li>
                            </ul>
                        </div>
                        <div class="products_filter_block products_filter_type">
                            <div class="products_filter_heading">
                            ...
                            <ul class="products_filter_menu">
                                <li class="products_filter_menu_item active">All</li>
                                <li class="products_filter_menu_item">Traditional</li>
                                <li class="products_filter_menu_item">Thin</li>
                            </ul>
                        </div>
                    </div>
            <div className="row">

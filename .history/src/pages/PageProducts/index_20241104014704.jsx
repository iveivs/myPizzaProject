...
function PageProducts() {
    ...
    const orderProduct = (e) => {
        // console.log('TEST', e.target.closest.dataset('[data-id]').getAttribute('data-id'));
        const nearestElement = element.closest('[data-id]');
        const dataIdValue = nearestElement ? nearestElement.getAttribute('data-id') : null;
        console.log('dataIdValue');
        setAmountOrderedProducts(() => {
            return amountOrderedProducts + 1
        })
    }
    return (
        <div className="indent container">
            <h2 id="product" className={`${styles.products_title}`}>Products</h2>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className={styles.product_wrapper}>
                                    ...
                                    <div className={styles.product_bottom} data-id={product.id}>
                                        ...
                                        >
                                            <i
                                                ...
                                                aria-hidden="true"
                                            ></i>
                                            <span className={styles.product_order}>Order</span>
                                        </a>
                                    </div>
                                </div>
                            </div>

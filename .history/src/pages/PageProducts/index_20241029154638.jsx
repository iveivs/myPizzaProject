...
function PageProducts() {
    console.log("TEST");
    return (
        <div classNameName="indent container">
            <h2 classNameName={`${styles.products_title}`}>Products</h2>
            <div className="products_filter">
                        <div className="products_filter_block products_filter_size">
                            ...
                            <ul className="products_filter_menu">
                                <li className="products_filter_menu_item active">All</li>
                        ...
                        <div className="products_filter_block products_filter_type">
                            ...
                            <ul className="products_filter_menu">
                                <li className="products_filter_menu_item active">All</li>
                                <li className="products_filter_menu_item">Traditional</li>
                ...
                {isDataArray(products) ? (
                    products.map((product) => {
                        return (
                            <div
                                key={product.id}
                                classNameName={"col-4 " + styles.product_item}
                            >
                                <img src={product.src} alt="" />
                                <div classNameName={styles.product_wrapper}>
                                    <div classNameName={styles.product_card_top}>
                                        <h3 classNameName={styles.product_name}>
                                            {product.name}
                                        </h3>
                                        <p classNameName={styles.product_description}>{product.description}</p>
                                    </div>
                                    <div classNameName={styles.product_bottom}>
                                        <p>{product.price} руб</p>
                                        <a
                                            href="#"
                                            classNameName={styles.product_button}
                                        >
                                            <i
                                                classNameName="fa fa-cart-arrow-down"
                                                aria-hidden="true"
                                            ></i>
                                            <span>Order</span>
                                        </a>

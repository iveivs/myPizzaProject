...
const products = [
    ...
    {id: 2, name: 'Товар 2', description: 'some text', price: 1000},
    {id: 3, name: 'Товар 3', description: 'some text', price: 1000},
    {id: 4, name: 'Товар 4', description: 'some text', price: 1000},
]
